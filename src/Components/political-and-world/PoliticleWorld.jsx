...
const PoliticleWorld = () => {
  ...
  return (
    <div className="politicle-world-container">
      <div className="header-wrapper">POLITICLE & WORLD</div>
          ...
          <Carousel activeIndex={index} onSelect={handleSelect}>
            <Carousel.Item>
              <div className="newsCards-container">
                <div className="cards">
                  <ActionCards size={"small"} data={data.slice(0, 4)} />
                </div>
              </div>
            </Carousel.Item>
            <Carousel.Item>
              <div className="newsCards-container">
                <div className="cards">
                  <ActionCards size={"small"} data={data.slice(4, 8)} />
                </div>
              </div>
            </Carousel.Item>
          </Carousel>
